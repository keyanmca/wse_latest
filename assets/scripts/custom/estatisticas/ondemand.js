...
// Verificar a URL
    ...
    $( '#aba_estatisticas_ondemand' ).on( 'shown.bs.tab', function ( e ) {
    ...
    function CalendarioEstatisticas( aplicacao ) {
        ...
        var h = {};
        if ( $( '#calendario_estatisticas_ondemand' ).width() <= 200 ) {
            $( '#calendario_estatisticas_ondemand' ).addClass( "mobile" );
            h = {
            ...
            $( '#calendario_estatisticas_ondemand' ).removeClass( "mobile" );
            if ( App.isRTL() ) {
                h = {
                    right: 'title',
                    center: '',
        ...
        $( '#calendario_estatisticas_ondemand' ).fullCalendar( 'destroy' ); // destroy the calendar
        $( '#calendario_estatisticas_ondemand' ).fullCalendar( { //re-initialize the calendar
