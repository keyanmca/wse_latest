(function ( a, w ) {
    ...
    var n = a.document, g = a.navigator, t = a.location, q = n.documentElement, p = [], c = {
...
(function ( a, w ) {
    ...
    var m = a.document.createElement( "i" ), k = m.style, s = " -o- -moz- -ms- -webkit- -khtml- ".split( " " ), r = ["Webkit", "Moz", "O", "ms", "Khtml"], n = a[a.head_conf && a.head_conf.head || "head"], g = {
        gradient: function () {
...
(function ( a, w ) {
    ...
    function n( a ) {
        var b = {};
        if ( "object" === typeof a )for ( var e in a )a[e] && (b = {
            name: e,
            url: a[e]
